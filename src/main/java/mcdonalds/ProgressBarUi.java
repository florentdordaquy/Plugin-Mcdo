...
public class ProgressBarUi extends BasicProgressBarUI {
    ...
    public ProgressBarUi() {
        McdoImg selectedBackground = ProgressBarSettingsState.getInstance().selectedBackground;
        bimage = selectedBackground.toBufferedImage();
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        ProgressBarSettingsState.getInstance().selectedCharacter.getIcon().paintIcon(progressBar, g, offset2 - JBUIScale.scale(3), -JBUIScale.scale(-2));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        ProgressBarSettingsState.getInstance().selectedCharacter.getIcon().paintIcon(progressBar, g2, amountFull - JBUIScale.scale(5), -JBUIScale.scale(1));
        g2.translate(0, -(c.getHeight() - h) / 2);
